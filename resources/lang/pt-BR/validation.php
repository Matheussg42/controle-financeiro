...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'phones.*.phoneType' => 'telefone',
        'first_name' => 'primeiro nome',
        'f_year' => 'ano de fabricação',
        'gender' => 'gênero',
        'hour' => 'hora',
        'last_name' => 'sobrenome',
        'name' => 'nome',
        ...
        'model' => 'modelo',
        'month' => 'mês',
        'm_year' => 'ano do modelo',
        'number' => 'número',
        'password_confirmation' => 'confirmação da senha',
        'password' => 'senha',
        'percent' => 'porcentagem',
        'pieces_discount' => 'desconto de peças',
        'plate' => 'placa',
        'phone' => 'telefone',
        'phones.0.phone' => 'telefones',
        'price' =>  'preço',
        'role' => 'cargo',
        'second' => 'segundo',
        'services_discount' => 'desconto de serviço',
        'sex' => 'sexo',
        'state' => 'estado',
        'street' => 'rua',
        'subject' => 'assunto',
